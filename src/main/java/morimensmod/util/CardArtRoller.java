...
import morimensmod.MorimensMod;
...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(MorimensMod.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(MorimensMod.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(MorimensMod.makeImagePath("masks/PowerMask.png"));
