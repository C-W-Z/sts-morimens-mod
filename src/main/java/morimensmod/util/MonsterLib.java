...
public class MonsterLib {
    ...
    public static class MonsterEncounter {
        ...
        public MonsterEncounter(MonsterGroup group, String[] actIDs, float[] weight, float scale) {
        ...
        public MonsterEncounter(MonsterGroup group, String[] actIDs, float weight) {
        ...
        public MonsterEncounter(AbstractMonster[] monsters, String[] actIDs, float weight) {
        ...
        public MonsterEncounter(AbstractMonster[] monsters, String[] actIDs, float weight, float scale) {
            this(monsters, actIDs, getFloats(actIDs.length, weight), scale);
        }

        public MonsterEncounter(AbstractMonster[] monsters, String[] actIDs, float[] weight, float scale) {
            this(new MonsterGroup(monsters), actIDs, weight, scale);
        }

        public MonsterEncounter(AbstractMonster[] monsters, String actID, float weight, float scale) {
            this(monsters, new String[] { actID }, weight, scale);
        }

        public MonsterEncounter(AbstractMonster[] monsters, String actID, float weight) {
