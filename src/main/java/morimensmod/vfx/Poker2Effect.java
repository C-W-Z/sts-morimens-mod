...
public class Poker2Effect extends AbstractGameEffect {

    public static final String NAME = "Poker2";
    ...
    public Poker2Effect(float centerX, float bottomY, boolean flipX) {
